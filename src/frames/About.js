            ...
            <div className="w-full bg-dgray min-h-[400px] flex flex-col items-center pt-14 pb-7 px-7 mt-10" id="reviews">
                ...
                >
                    <SwiperSlide className="w-fit">
                        <Review name="PrinceJ" text="I saw Mia before heading to Europe and let me tell you she has me typing this message 4000 miles away from Canada.. her pictures don’t do her justice..especially with those juicy plump lips, best bbj experience ive received, treat her good fellas" />
                    </SwiperSlide>
                    <SwiperSlide>
                    ...
                    <SwiperSlide>
                        <Review name="Bp1241" text="As an avid Diamond agency person Mia has completely stopped this for me as I became a regular for her, im a very picky person especially when it comes to RP but Mia is extremely patient and intellectual which was also a big turn on for me" />
                    </SwiperSlide>
                    <SwiperSlide>
                        <Review name="Blueman2" text="Very busy woman but very much worth the wait" />
                    </SwiperSlide>
                    <SwiperSlide>
                        <Review name="Chipdude69" text="Mia was amazing!! Did overnights with her and was way more into kink friendly suggestions which is a bonus" />
                    </SwiperSlide>
                    <SwiperSlide>
                        <Review name="Canuckslover63" text="I had a session with Mia at her downtown incall not too long ago, very adorable, petite, with an amazing body and damn, she gives an excellent tease to build up tension. It’s good to know she’s good for the price she charges" />
                    </SwiperSlide>
                    <SwiperSlide>
                    ...
                    <SwiperSlide>
                        <Review name="Rockson" text="Contacted her via email for an online session since I like to build up connection and was 100% worth it. Ended up doing 3 online sessions as I ended up travelling for work but still communicated with Mia, will be seeing her when I’m back in 1-2 months.. will be writing a follow up review, Thank you, my darling Mia, I can’t wait" />
                    </SwiperSlide>
                    <SwiperSlide>
                    ...
                    <SwiperSlide>
                        <Review name="Will2serveU" text="Gentlemen, I just wanted to put in a quick plug for Mia who is a truly hidden gem …hot session. Reverse cowgirl is forever etched in my memory, unfortunately I am heading back to the States but as she requested for me to leave a review this will not do her any justice. You must experience it for yourself" />
                    </SwiperSlide>
                    <SwiperSlide>
                        <Review name="GeneralG" text="I reached out after a cancellation, and Miss Mia did not disappoint. Very personable, friendly, and the skills on point. One of the greatest asses around, and knows how to get to work. Great communication for this meeting, 10/10 would recommend and visit again." />
                    </SwiperSlide>
                    <SwiperSlide>
                        <Review name="LongHorn" text="Mia immediately made me feel comfortable and at ease with her warm, friendly demeanour. She listened carefully to my concerns and tailored the session to my needs no worries. She asked me to cuddle to warm her up before she started giving me a massage which was pretty damn cute… I couldn’t help but feast my eyes on her absolutely perfect body, this goddess's skills were truly angelic. Beautiful perky breasts with responsive nipples. Nice voluptuous round bum and one of the prettiest and tightest little kitties I have had the pleasure to be inside… I will keep the details to my memories but I would highly recommend her" />
                    </SwiperSlide>
                </Swiper>
            </div>
