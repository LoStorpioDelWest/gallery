            ...
            <div className="w-full bg-dgray min-h-[400px] flex flex-col items-center pt-14 pb-7 px-7 mt-10" id="reviews">
                ...
                >
                    <SwiperSlide className="w-fit">
                        <Review name="PrinceJ" text="I saw Tia before heading to Europe and let me tell you she has me typing this message 4000 miles away from Canada.. her pictures don’t do her justice..especially with those juicy plump lips, best bbj experience ive received, treat her good fellas" />
                    </SwiperSlide>
                    <SwiperSlide>
                    ...
                    <SwiperSlide>
                        <Review name="Canuckslover63" text="I had a session with Tia at her downtown incall not too long ago, very adorable, petite, with an amazing body and damn, she gives an excellent tease to build up tension. It’s good to know she’s good for the price she charges" />
                    </SwiperSlide>
                    <SwiperSlide>
                    ...
                    <SwiperSlide>
                        <Review name="GeneralG" text="I reached out after a cancellation, and Miss Tia did not disappoint. Very personable, friendly, and the skills on point. One of the greatest asses around, and knows how to get to work. Great communication for this meeting, 10/10 would recommend and visit again." />
                    </SwiperSlide>
                    <SwiperSlide>
